...
## Pass 3 — Focus holds every replay mode *(done — View bar remounted in Step B)*
...
See also `docs/product-notes.md` — Focus entry should stay on the mushaf half, not only in settings.
