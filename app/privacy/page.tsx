    ...
    <LegalArticle title="Privacy" from={from} updated="13 September 2026">
      ...
      <LegalSection title="Payments">
        <p>
          ...
          you know the subscription actually turned on. If you gift Plus, you sign in first, enter the
          ...
          account. Paystack and Stripe still send their own receipts. Those payment fields stay on the server; the
          app never shows payment refs. Your Clerk account ID is shown only to you on the account page so you can
          quote it if something goes wrong. We log payment confirmation and renewal events (plan, processor,
          success or failure, and that same account ID — never your email) so a paid subscription can be fulfilled
          and later invoices keep Plus on. If you dispute or charge back a Plus payment, we turn Plus off on the
          signed-in account. Paystack and Stripe dashboards are the payment ledger. Their privacy policies apply to
          the checkout pages. Sign-in is handled by Clerk.
        </p>
      </LegalSection>
