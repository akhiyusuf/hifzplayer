...
Diras Plus unlocks Focus play — Word Reps, Masked, and Relay — plus 3× and unlimited word repeats, and more than one qari in relay. You can open Focus and look around without paying. A one-day free trial needs a signed-in account (sign in or sign up first; one trial per account; no card). Quran reading, audio, translation, tajweed, and verse Repeat stay free. Recurring phrases and near-twins are coming soon.
...
To gift Plus, sign in, choose **Gift someone** on `/pricing`, enter an email that already has a Diras account, then pay. Checkout is blocked until that email matches our records. **For me** still buys Plus for the signed-in account.
